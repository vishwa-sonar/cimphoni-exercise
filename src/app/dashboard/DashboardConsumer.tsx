...
const DashboardConsumer = () => {
  //   const promptData = useContext(DashboardContext) as unknown as any;
  //
          ...
          prompts?.map((item: any) => {
            return (
              <div
                ...
                className="flex cursor-pointer hover:bg-blue-600 items-center bg-blue-500 mb-2 text-white text-sm font-bold px-4 py-3"
                role="alert"
              >
                <svg
